...
- [x] 1. ShopLocation Value Object作成
...
- [x] 2. ShopSearchResult Value Object作成
...
- [x] 3. Domain Service Interface作成
...
- [x] 7. rate_limiter_stateマイグレーション作成
...
- [x] 10. ShopRepository Interface作成
...
- [x] 16. shop_location_fieldsマイグレーション作成
...
- [x] 17. ShopSearchInput Component作成
...
- [x] 18. ShopSearchDropdown Component作成
...
- [x] 21. ShopSearchResult Unit Tests
...
- [x] 24. NominatimClient Unit Tests
...
- [x] 25. SearchShopUseCase Unit Tests
...
- [x] 26. searchShopAction Integration Tests
...
- [x] 29. Ubiquitous Language Dictionary更新
